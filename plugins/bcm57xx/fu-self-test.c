...
static void
fu_bcm57xx_checksum_func (void)
{
	guint8 buf[] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09 };
	g_assert_cmpint (fu_bcm57xx_nvram_crc (buf, sizeof(buf), 0x0), ==, 0xCF401959);
	g_assert_cmpint (fu_bcm57xx_nvram_crc (buf, sizeof(buf), 0xffffffff), ==, 0x9EABEF40);
}
...
main (int argc, char **argv)
{
	...
	/* tests go here */
	g_test_add_func ("/fwupd/bcm57xx/checksum", fu_bcm57xx_checksum_func);
